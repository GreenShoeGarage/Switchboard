/*
 * SWITCHBOARD Agent v0.5.0-hil-candidate
...
constexpr char AGENT_VERSION[] = "0.5.0-hil-candidate";
...
void processProvisioningLine(const String &line) {
  ...
  if (strcmp(action, "provision") != 0) {
    logEvent("WARN", "PROVISION_ACTION_UNKNOWN", "Use provision, status, or clear");
    return;
  }
